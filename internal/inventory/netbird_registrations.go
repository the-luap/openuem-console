...
type NetbirdRegistration struct {
	...
	LastPeerRemoval                               *NetbirdPeerRemovalAttempt
	PeerAbsence                                   *NetbirdPeerAbsence
