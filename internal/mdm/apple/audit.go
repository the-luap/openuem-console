...
func (s *Store) RecordRead(ctx context.Context, scope Scope, actor, action, resource string) error {
	...
	switch action {
	case "software.catalog.read", "software.inventory.read", "ade.inventory.read", "inventory.list", "inventory.read", "user.inventory.read", "profile.download", "profile.history.read", "profile.revision.download":
	default:
