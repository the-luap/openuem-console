...
func scopedFormLimit(path string) int64 {
	...
	if route == "/profiles/new" || route == "/profiles/:uuid" || route == "/profiles/:uuid/enable" || route == "/profiles/:uuid/disable" || route == "/profiles/:uuid/setglobal" || route == "/profiles/:uuid/settenant" {
		return 8192
	}
