...
func TestCSRFLimitsWindowsFormsBeforeTokenExtraction(t *testing.T) {
	for _, route := range []string{"/windows/setup", "/tenant/:tenant/windows/invitations", "/tenant/:tenant/site/:site/windows/:id/revoke"} {
		...
		path := strings.NewReplacer(":profile", "17", ":tenant", "1", ":site", "11", ":id", "device").Replace(route)
...
func TestCSRFSmallFormsRejectWirePaddingWithEitherTokenPath(t *testing.T) {
	for _, route := range []string{"/tenant/:tenant/site/:site/computers/:uuid/netbird/removals", "/tenant/:tenant/site/:site/computers/:uuid/netbird/removals/:request/cancel", "/tenant/:tenant/site/:site/computers/:uuid/netbird/removals/:request/observe", "/tenant/:tenant/site/:site/computers/:uuid/netbird/removals/:request/resolution", "/tenant/:tenant/site/:site/computers/:uuid/netbird/removals/:request/resolution/reconcile", "/tenant/:tenant/site/:site/computers/:uuid/netbird/installations", "/tenant/:tenant/site/:site/computers/:uuid/netbird/installations/:request/cancel", "/tenant/:tenant/site/:site/computers/:uuid/netbird/installations/:request/observe", "/tenant/:tenant/site/:site/computers/:uuid/netbird/installations/:request/resolution", "/tenant/:tenant/site/:site/computers/:uuid/netbird/installations/:request/resolution/reconcile", "/tenant/:tenant/site/:site/computers/:uuid/execution", "/tenant/:tenant/site/:site/computers/:uuid/runtask", "/tenant/:tenant/site/:site/computers/:uuid/runprofile", "/tasks/:id", "/tenant/:tenant/tasks/:id", "/tenant/:tenant/site/:site/tasks/:id", "/tasks/:profile/new", "/tenant/:tenant/tasks/:profile/new", "/tenant/:tenant/site/:site/tasks/:profile/new", "/tasks/:id/clone", "/tenant/:tenant/tasks/:id/clone", "/tenant/:tenant/site/:site/tasks/:id/clone", "/tasks/:id/moveup/:order", "/tasks/:id/movedown/:order", "/tasks/:id/movefrom/:from/to/:to", "/tenant/:tenant/tasks/:id/moveup/:order", "/tenant/:tenant/tasks/:id/movedown/:order", "/tenant/:tenant/tasks/:id/movefrom/:from/to/:to", "/tenant/:tenant/site/:site/tasks/:id/moveup/:order", "/tenant/:tenant/site/:site/tasks/:id/movedown/:order", "/tenant/:tenant/site/:site/tasks/:id/movefrom/:from/to/:to", "/tasks/:id/enable", "/tasks/:id/disable", "/tenant/:tenant/tasks/:id/enable", "/tenant/:tenant/tasks/:id/disable", "/tenant/:tenant/site/:site/tasks/:id/enable", "/tenant/:tenant/site/:site/tasks/:id/disable", "/tenant/sites", "/profiles/:uuid/clone", "/tenant/:tenant/profiles/:uuid/clone", "/tenant/:tenant/site/:site/profiles/:uuid/clone", "/profiles/new", "/tenant/:tenant/profiles/new", "/tenant/:tenant/site/:site/profiles/new", "/profiles/:uuid", "/tenant/:tenant/profiles/:uuid", "/tenant/:tenant/site/:site/profiles/:uuid", "/profiles/:uuid/setglobal", "/profiles/:uuid/settenant", "/tenant/:tenant/profiles/:uuid/setglobal", "/tenant/:tenant/profiles/:uuid/settenant", "/tenant/:tenant/site/:site/profiles/:uuid/setglobal", "/tenant/:tenant/site/:site/profiles/:uuid/settenant", "/profiles/:uuid/enable", "/profiles/:uuid/disable", "/tenant/:tenant/profiles/:uuid/enable", "/tenant/:tenant/site/:site/profiles/:uuid/disable", "/profiles/:uuid/tags", "/tenant/:tenant/profiles/:uuid/tags", "/tenant/:tenant/site/:site/profiles/:uuid/tags", "/agents", "/tenant/:tenant/computers", "/tenant/:tenant/site/:site/agents", "/tenant/:tenant/site/:site/computers", "/tenant/:tenant/site/:site/ios/update-plans/:plan/group-assignments/:assignment/promotions", "/tenant/:tenant/site/:site/ios/update-plans/:plan/group-assignments/:assignment/removals", "/tenant/:tenant/site/:site/ios/update-plans/:plan/schedules", "/tenant/:tenant/site/:site/ios/update-plans/:plan/schedules/:schedule/cancel", "/login/new", "/ios/:id/update", "/tenant/:tenant/site/:site/ios/update-plans/:plan/group-assignments", "/tenant/:tenant/site/:site/ios/update-plans", "/devices/export", "/device-groups", "/tenant/:tenant/site/:site/device-groups/:group", "/tenant/:tenant/site/:site/ios/configurations/:id/assign", "/tenant/:tenant/site/:site/ios/configurations/:id/group-assignments"} {
		for _, header := range []bool{false, true} {
			e := echo.New()
			e.Use(CSRF())
			e.POST(route, func(echo.Context) error { t.Fatal("oversized normalized form reached handler"); return nil })
			path := strings.NewReplacer(":profile", "17", ":tenant", "1", ":site", "11", ":uuid", "17", ":id", "profile", ":group", "group", ":plan", "plan").Replace(route)
			token := strings.Repeat("a", 32)
