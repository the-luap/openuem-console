...
func exerciseWindowsConsole(t *testing.T, h *Handler, e *echo.Echo, ctx context.Context, tenant, site int) {
	...
	exerciseWindowsGroupSchedules(t, h, ctx, scope, deviceID, request)
	...
	exerciseWindowsUnenrollment(t, h, ctx, scope, request, artifact)
	exerciseWindowsUnenrollmentRequests(t, h, ctx, scope, request, artifact)
