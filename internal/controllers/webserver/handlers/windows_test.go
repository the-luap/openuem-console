...
func TestWindowsConsoleRoutesHaveExplicitCapabilities(t *testing.T) {
	...
	for _, route := range []string{"GET /windows/:id/disconnections", "GET /windows/:id/disconnections/new", "GET /windows/:id/disconnections/:request", "POST /windows/:id/disconnections/preview", "POST /windows/:id/disconnections/create", "POST /windows/:id/disconnections/:request/cancel", "POST /windows/:id/disconnections/:request/release"} {
		want[route] = access.RevokeDevices
	}
	for _, route := range []string{"GET /windows/update-rings", "GET /windows/update-rings/new", "GET /windows/update-rings/:ring", "GET /windows/update-rings/:ring/edit", "POST /windows/update-rings/preview", "POST /windows/update-rings/save", "GET /windows/update-rings/:ring/assign", "GET /windows/update-rings/:ring/assign/groups", "POST /windows/update-rings/:ring/assign/preview", "POST /windows/update-rings/:ring/assign/create", "GET /windows/update-rollouts/:rollout", "GET /windows/update-rings/:ring/schedule", "GET /windows/update-rings/:ring/schedule/groups", "POST /windows/update-rings/:ring/schedule/preview", "POST /windows/update-rings/:ring/schedule/create", "GET /windows/update-schedules", "GET /windows/update-schedules/:schedule", "POST /windows/update-schedules/:schedule/cancel"} {
		want[route] = access.ManageUpdates
	}
	for _, route := range []string{"POST /windows/:id/commands/:command/export", "POST /windows/:id/commands/:command/observations/:message/export", "GET /windows/:id/commands/:command/observations", "GET /windows/:id/commands/:command/observations/:message", "GET /windows/:id/commands/new", "POST /windows/:id/commands/preview", "POST /windows/:id/commands/create", "GET /windows/:id/commands", "GET /windows/:id/commands/:command", "POST /windows/:id/commands/:command/cancel", "POST /windows/:id/commands/:command/abandon"} {
		want[route] = access.ManageWindowsCSP
	}
	for _, route := range []string{"GET /windows/certificate-reminders", "GET /windows/certificate-health", "GET /windows/:id/renewals", "GET /windows/:id/renewals/:renewal", "POST /windows/:id/renewals/:renewal/cancel"} {
