...
func TestWindowsConsoleRoutesHaveExplicitCapabilities(t *testing.T) {
	...
	for _, route := range []string{"GET /windows/update-rings", "GET /windows/update-rings/new", "GET /windows/update-rings/:ring", "GET /windows/update-rings/:ring/edit", "POST /windows/update-rings/preview", "POST /windows/update-rings/save", "GET /windows/update-rings/:ring/assign", "GET /windows/update-rings/:ring/assign/groups", "POST /windows/update-rings/:ring/assign/preview", "POST /windows/update-rings/:ring/assign/create", "GET /windows/update-rollouts/:rollout", "GET /windows/update-rings/:ring/schedule", "POST /windows/update-rings/:ring/schedule/preview", "POST /windows/update-rings/:ring/schedule/create", "GET /windows/update-schedules", "GET /windows/update-schedules/:schedule", "POST /windows/update-schedules/:schedule/cancel"} {
