...
func exerciseDesktopInventoryPermissions(t *testing.T, h *Handler, ctx context.Context, tenant, site, sibling, otherTenant, otherSite int, request func(string, string, string, url.Values) *httptest.ResponseRecorder) {
	...
	for _, user := range []string{"scoped-viewer", "scoped-operator", "organization-admin"} {
		for _, endpoint := range []struct{ method, suffix string }{{"POST", "/overview"}, {"DELETE", ""}, {"GET", "/notes"}, {"GET", "/remote-assistance"}, {"GET", "/power"}, {"POST", "/software"}, {"POST", "/network-adapters"}, {"POST", "/inventory/network"}, {"POST", "/physical-disks"}, {"POST", "/inventory/storage"}, {"POST", "/logical-disks"}, {"POST", "/logical-disks/file"}, {"PUT", "/logical-disks/file"}, {"DELETE", "/logical-disks/file"}, {"POST", "/logical-disks/downloadfile"}, {"POST", "/logical-disks/downloadfolder"}, {"POST", "/logical-disks/downloadmany"}, {"POST", "/logical-disks/folder"}, {"PUT", "/logical-disks/folder"}, {"DELETE", "/logical-disks/folder"}, {"DELETE", "/logical-disks/many"}, {"POST", "/hardware"}, {"POST", "/os"}, {"POST", "/printers"}, {"POST", "/monitors"}, {"POST", "/inventory/peripherals"}} {
