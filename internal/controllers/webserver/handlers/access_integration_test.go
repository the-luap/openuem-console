...
func exerciseConsolePermissions(t *testing.T, h *Handler, e *echo.Echo, ctx context.Context, tenantID, siteID int, profileID string) {
	...
	t.Run("profile creation retains scoped audit", func(t *testing.T) {
		...
		exerciseProfileCloningScope(t, h, e, ctx, tenantID, siteID)
		exerciseTaskStatusScope(t, h, e, ctx, tenantID, siteID)
		...
		exerciseTaskWizardScope(t, h, e, ctx, tenantID, siteID)
		exerciseTaskEditingScope(t, h, e, ctx, tenantID, siteID)
		exerciseSMTPSettingsRoutes(t, h, e, ctx, tenantID)
		exerciseNetbirdSettingsRoutes(t, h, e, ctx, tenantID)
		exerciseNetbirdPackageRoutes(t, h, e, ctx, tenantID, otherTenant.ID)
	})
	...
	t.Run("reviewed desktop assignment", func(t *testing.T) {
		exerciseDeviceAssignmentRoutes(t, h, ctx, tenantID, siteID, sibling.ID, otherSite.ID, request)
	})
	...
	t.Run("original Apple update group removal", func(t *testing.T) {
		exerciseAppleUpdateRemovals(t, h, ctx, tenantID, siteID, request)
	})
	t.Run("Apple update group assignments", func(t *testing.T) {
		exerciseAppleUpdateGroups(t, h, ctx, tenantID, siteID, request)
	})
	t.Run("Apple update plans", func(t *testing.T) {
		exerciseAppleUpdatePlans(t, h, ctx, tenantID, siteID, request)
	})
	...
	t.Run("Apple organization update groups", func(t *testing.T) {
		exerciseAppleUpdateOrganizationGroups(t, h, ctx, tenantID, siteID, request)
	})
	t.Run("Apple organization profile groups", func(t *testing.T) {
		exerciseAppleProfileOrganizationGroups(t, h, ctx, tenantID, siteID, request)
	})
