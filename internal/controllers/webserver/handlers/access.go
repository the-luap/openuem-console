...
func appleCapability(method, path string) (access.Capability, bool) {
	...
	if method == http.MethodPost {
		...
		case "/ios/:id/update-exceptions", "/ios/update-plans/:plan/group-assignments/:assignment/removals", "/ios/update-plans/:plan/schedules", "/ios/update-plans/:plan/schedules/:schedule/cancel", "/ios/:id/update", "/ios/update-plans", "/ios/update-plans/:plan", "/ios/update-plans/:plan/group-assignments":
			return access.ManageUpdates, true
