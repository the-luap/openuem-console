...
func appleCapability(method, path string) (access.Capability, bool) {
	...
	if method == http.MethodGet {
		switch route {
		case "/software/catalog/:version/sources", "/software/catalog/:version/sources/:source":
			return access.ReadSoftware, true
		case "/software/catalog/:version/sources/:source/review":
		...
		case "/software/catalog", "/software/catalog/:version", "/ios/:id/applications", "/ios/:id/applications/:assignment/history", "/ios/:id/setup/applications/:requirement/history":
			return access.ReadSoftware, true
		case "/ios/update-plans/:plan/group-assignments/:assignment/promotion", "/ios/update-plans/:plan/group-assignments/:assignment/promotion/groups", "/ios/update-plans/:plan/group-assignments/:assignment/promotion/review", "/ios/update-plans/:plan/group-assignments/:assignment/promotions", "/ios/update-plans/:plan/group-assignments/:assignment/promotions/:promotion", "/ios/update-alerts", "/ios/update-plans/:plan/group-assignments/:assignment/escalation", "/ios/update-plans/:plan/group-assignments/:assignment/escalation/events", "/ios/update-plans/:plan/group-assignments/:assignment/escalation/events/:event", "/ios/:id/update-exceptions", "/ios/:id/update-exceptions/review", "/ios/:id/update-exceptions/:exception", "/ios/update-plans/:plan/group-assignments/:assignment/removal", "/ios/update-plans/:plan/group-assignments/:assignment/removals", "/ios/update-plans/:plan/group-assignments/:assignment/removals/:removal", "/ios/update-plans/:plan/group-assignments/:assignment/progress", "/ios/update-plans/:plan/schedules", "/ios/update-plans/:plan/schedules/:schedule", "/ios/update-plans/:plan/groups", "/ios/update-plans/:plan/groups/:group/preview", "/ios/update-plans/:plan/group-assignments", "/ios/update-plans/:plan/group-assignments/:assignment":
	...
	if method == http.MethodPost {
		...
		case "/ios/update-plans/:plan/group-assignments/:assignment/promotions", "/ios/update-plans/:plan/group-assignments/:assignment/escalation", "/ios/update-plans/:plan/group-assignments/:assignment/escalation/acknowledge", "/ios/:id/update-exceptions", "/ios/update-plans/:plan/group-assignments/:assignment/removals", "/ios/update-plans/:plan/schedules", "/ios/update-plans/:plan/schedules/:schedule/cancel", "/ios/:id/update", "/ios/update-plans", "/ios/update-plans/:plan", "/ios/update-plans/:plan/group-assignments":
			return access.ManageUpdates, true
