...
func appleCapability(method, path string) (access.Capability, bool) {
	...
	if method == http.MethodGet {
		...
		case "/ios/setup/requests/:id/csr", "/ios/setup/requests/:id/portal":
	...
	if method == http.MethodPost {
		switch route {
		case "/ios/setup", "/ios/setup/requests", "/ios/setup/requests/:id/revoke", "/ios/setup/requests/:id/certificate", "/ios/setup/requests/:id/vendor":
			return access.ManageCertificates, true
		case "/ios/enroll":
		...
		case "/ios/:id/filevault", "/ios/:id/filevault/keys/:key/verify", "/ios/:id/filevault/keys/:key/rotate", "/ios/:id/recovery-lock":
			return access.ManageDeviceSecurity, true
		case "/ios/:id/filevault/keys/:key/reveal", "/ios/:id/recovery-lock/passwords/:key/reveal":
