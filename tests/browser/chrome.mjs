...
const fixtures = new Set([
 ...
 ...['review','review-long','review-no-manifest','review-max','queued','delivery-pending','unconfirmed','viewer','stopped','cancelled','completed','released','history','history-empty','history-full','resolution-withdraw','resolution-release','resolution-retry','resolution-waiting','resolution-conflict','resolution-confirm','resolution-completed','resolution-released','resolution-long'].map(kind=>'netbird-removal-stage-cleanups-'+kind),
 ...['choices','choices-empty','choices-long','review','review-long','queued','preparation-pending','prepared','delivery-pending','unconfirmed','viewer','stopped','cancelled','completed','released','history','history-empty','history-full','resolution-withdraw','resolution-release','resolution-retry','resolution-waiting','resolution-conflict','resolution-confirm','resolution-completed','resolution-released','resolution-long'].map(kind=>'netbird-installations-'+kind),
 ...['present','retry','long','absent','retained','changed','unavailable','unassociated','receipt','receipt-viewer'].map(kind=>'netbird-registrations-removal-'+kind),
 ...['peer-matched','peer-long','peer-retained','peer-missing','peer-unavailable','peer-conflict','peer-absent','peer-cleanup-required','peer-key-unknown','peer-not-delivered','peer-receipt','peer-receipt-viewer','cleanup-ready','cleanup-retry','cleanup-long','cleanup-absent','cleanup-retained','cleanup-changed','cleanup-unavailable','choices','choices-empty','choices-long','review','review-empty','review-long','queued','started','completed','stopped','unconfirmed-create','unconfirmed-delivery','unconfirmed-cleanup','unconfirmed-cleaned','unconfirmed-viewer','history','history-empty','history-full','unconfirmed-resolved','history-resolved','resolution-completed','resolution-release','resolution-cleanup','resolution-no-delivery','resolution-continue','resolution-pending','resolution-confirmed','resolution-unknown-key','resolution-missing-receipt','resolution-active','resolution-changed-key','resolution-unavailable','resolution-long','resolution-withdraw','resolution-withdraw-cleanup','resolution-withdrawn','resolution-recovery-unavailable','resolution-retry-release','resolution-retry-withdraw','resolution-retry-long'].map(kind=>'netbird-registrations-'+kind),
 ...
 ...["new","empty","list","list-viewer","detail","detail-viewer","revoked","long"].map(kind=>"netbird-packages-"+kind),
 ...["ordinary","duplicate","legacy","injected","empty","malformed"].map(kind=>"netbird-profiles-"+kind),
 ...['overview','overview-empty','overview-long','overview-viewer','review-up','review-down','review-switch','review-long','queued','sending','completed','stopped','unconfirmed','released','history','history-empty','resolution-completed','resolution-release','resolution-pending','resolution-confirmed','resolution-waiting','resolution-missing','resolution-conflict','resolution-long','resolution-retry','resolution-retry-long','resolution-withdraw','resolution-withdraw-long','resolution-withdraw-pending','resolution-withdrawn','resolution-withdraw-completed','resolution-retry-withdraw','resolution-withdraw-retry-release','resolution-recovery-unavailable','resolution-withdraw-waiting','resolution-full'].map(kind=>'netbird-operations-'+kind),
 ...
 ...["list","empty","detail","used","viewer","long","list-viewer","administrator","legacy-palette"].map(state=>`organization-tags-${state}`),
 "tag-color-compatibility",
 ...
 ...["viewer","operator"].flatMap(role=>["first","next","empty","long","missing","negative"].map(state=>`desktop-security-${state}-${role}`)),
 ...
 ...["en","de","ca","es","fr","no","pt"].map(locale=>"windows-timestamps-"+locale),
