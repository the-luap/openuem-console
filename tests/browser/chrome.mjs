...
const fixtures = new Set([
 ...['choices','choices-empty','choices-long','review','review-empty','review-long','queued','started','completed','stopped','unconfirmed-create','unconfirmed-delivery','unconfirmed-cleanup','unconfirmed-cleaned','unconfirmed-viewer','history','history-empty','history-full','unconfirmed-resolved','history-resolved','resolution-completed','resolution-release','resolution-cleanup','resolution-no-delivery','resolution-continue','resolution-pending','resolution-confirmed','resolution-unknown-key','resolution-missing-receipt','resolution-active','resolution-changed-key','resolution-unavailable','resolution-long','resolution-withdraw','resolution-withdraw-cleanup','resolution-withdrawn','resolution-recovery-unavailable'].map(kind=>'netbird-registrations-'+kind),
