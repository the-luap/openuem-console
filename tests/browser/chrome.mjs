...
const fixtures = new Set([
 ...["empty","pending","other-owner","reader","site","expired","withdrawn","approved","focused","paged","review","incompatible","review-expired","review-withdrawn","review-approved","derived"].map(state=>"windows-source-"+state),
