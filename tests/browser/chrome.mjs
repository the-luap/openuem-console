...
const fixtures = new Set([
 ...
 ...['overview','overview-empty','overview-long','overview-viewer','review-up','review-down','review-switch','review-long','queued','sending','completed','stopped','unconfirmed','released','history','history-empty','resolution-completed','resolution-release','resolution-pending','resolution-confirmed','resolution-waiting','resolution-missing','resolution-conflict','resolution-long','resolution-retry','resolution-retry-long'].map(kind=>'netbird-operations-'+kind),
