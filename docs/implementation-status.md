...
- [Desktop identity renewal](desktop-identity-renewal.md) pins shared registry
  `e0d6829` with persistent preparation, candidate-key confirmation, permanent key
  ownership, exact generation retries and bounded broker-session handoff. Its
  [CI](https://github.com/the-luap/openuem-nats/actions/runs/34469009791) passes native
  ...
  complete Linux/Windows builds pass. Automatic endpoint renewal,
  historical reconciliation, runtime/release integration and physical acceptance
  remain open.
