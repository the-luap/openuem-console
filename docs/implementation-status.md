...
- Agent commits `81ed1be`, `62561fb` and `b87cbce` harden the existing Windows package execution path with
  ...
  This is WIN-01 implementation progress, not completion: approved catalogs,
  detection, reboots, transactional recovery and physical package acceptance
  remain required. Individually enrolled agents do not gain legacy package
