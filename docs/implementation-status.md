...
- [Windows server-requested disconnection](native-windows-unenrollment.md#server-requested-disconnection-and-explicit-review)
  ...
  capacity. Vet and Linux/Windows builds pass. Full CI is pending. Dedicated console
  forms and physical Windows recovery/cleanup acceptance remain open.
