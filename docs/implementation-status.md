...
- [Native Windows discovery](native-windows-mdm.md) adds a bounded UTF-8 SOAP 1.2
  ...
  Credential/CA console and gateway integration, verified CSR issuance,
  provisioning and real Windows enrollment remain open.
