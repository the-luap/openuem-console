...
- [Windows renewal SOAP admission](native-windows-renewal.md) registers a separate
  ...
  seconds and now runs in CI. Vet and both platform builds pass. Full CI for this
  extension is pending. Account/federated renewal, complete lifecycle controls,
