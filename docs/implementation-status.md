...
- [Windows certificate replacement console](native-windows-renewal.md#review-and-cancel-a-replacement-in-the-console)
  ...
  contained 390/768/1440-pixel layouts. Full CI for this extension is pending.
  Account/federated renewal, scheduling/expiry reporting, unenrollment and real
  Windows acceptance remain open; WIN-02 stays in progress.
- [Windows disconnection notifications](native-windows-unenrollment.md) accept
  ...
  report views and retained uncertain-command navigation. Full CI is pending.
  Server-requested disconnection, missing notifications and physical Windows
  cleanup acceptance remain open; WIN-02 stays in progress.
