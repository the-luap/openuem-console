...
- [Windows CSP evidence exports](native-windows-csp-export.md) add scoped,
  ...
  Vet and Linux/Windows builds pass; full CI is pending.
  Retention, physical acceptance and the full WIN-02 scope remain open.
...
- [Windows certificate reminders](native-windows-certificate-reminders.md) add
  ...
  checks. Vet and Linux/Windows builds pass; full CI is pending. Production
  SMTP/inbox acceptance and physical Windows renewal continuity remain open.
