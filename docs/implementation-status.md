...
- [Native Windows enrollment/device console](native-windows-console.md) adds
  ...
  pending. The initial `f7a2d6e` workflows failed the gateway schedule fixture
  ...
  one CPU pass. Updated full CI is still running.
- [Windows update run console](native-windows-update-console.md) adds scoped
  ...
  builds pass; full CI is pending. Policy/ring/schedule creation, raw CSP views
  and the remaining WIN-02 requirements stay open.
